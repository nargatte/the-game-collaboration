...
namespace PlayerCoreUnitTests
{
    ...
    class TestBoard : Shared.Components.Boards.IBoard
    {

        BoardPrototypeFactory board;

        public TestBoard()
        {
            board = new BoardPrototypeFactory();
        }
        ...
        public IEnumerable<IPiece> Pieces => throw new NotImplementedException();

        public IEnumerable<IPlayer> Players => throw new NotImplementedException();

        public IBoardPrototypeFactory Factory => throw new NotImplementedException();
        ...
        public void SetPiece(IPiece value)
        {
            throw new NotImplementedException();
        }
