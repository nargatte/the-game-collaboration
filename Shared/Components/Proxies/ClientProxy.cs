...
namespace Shared.Components.Proxies
{
	public class ClientProxy : ClientProxyBase
	{
		...
		public ClientProxy( INetworkClient client, uint keepAliveInterval, CancellationToken cancellationToken ) : base( client, keepAliveInterval, cancellationToken )
		{
			//disconnection = new TaskDelayer( CheckDisconnection, KeepAliveInterval, CancellationToken );
		}
