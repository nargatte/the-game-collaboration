...
namespace Shared.Components.Factories
{
	public class BoardComponentFactory : IBoardComponentFactory
	{
		...
		public virtual IPlayer CreatePlayer( ulong id, TeamColour team, PlayerRole type, DateTime timestamp, IField field, IPlayerPiece piece ) => new Player( id, team, type, timestamp, field, piece );		
		#endregion
	}
}
