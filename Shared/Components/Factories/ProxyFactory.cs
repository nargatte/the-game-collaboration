...
namespace Shared.Components.Factories
{
	...
	{
		public virtual IClientProxy CreateClientProxy( INetworkClient client, uint keepAliveInterval, CancellationToken cancellationToken ) => new ClientProxy( client, keepAliveInterval, cancellationToken );
